			 ...
			 IN PCHAR DebugMessage )
{
    ...
    sprintf ( DebugMessage, "%s %s",
	      ( DeviceExtension->IsBus ? "Bus" : "Disk" ),
	...
	if ( !DeviceExtension->IsBus
		...
		sprintf ( DebugMessage,
			  "%s StorageDeviceProperty", DebugMessage );
		break;
	    case StorageAdapterProperty:
		sprintf ( DebugMessage,
			  "%s StorageAdapterProperty", DebugMessage );
		break;
	    default:
		sprintf ( DebugMessage,
		...
		sprintf ( DebugMessage,
			  "%s PropertyStandardQuery", DebugMessage );
		break;
	    case PropertyExistsQuery:
		sprintf ( DebugMessage,
			  "%s PropertyExistsQuery", DebugMessage );
		break;
	    default:
		sprintf ( DebugMessage,
